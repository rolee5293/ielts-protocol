...
export const AGENTS: AgentDef[] = [
  ...
  { id: "nova-k", codename: "NOVA-K", cnName: "新星", role: "军师 / STRATEGIST", emoji: "🌟", color: "#3DDBD9", unlockDesc: "累计掌握 500 词", cond: (s) => s.stats.masteredCount >= 500 },
...
export const PEAKS: PeakDef[] = [
  ...
  { level: 5, name: "锋刃", en: "EDGE", minXp: PEAK_XP[4], challenge: "单次测验打出 10 连击",
    progress: (s) => ({ cur: s.stats.bestCombo, need: 10 }) },
  { level: 6, name: "熔炼", en: "FORGE", minXp: PEAK_XP[5], challenge: "掌握 300 个单词",
    progress: (s) => ({ cur: s.stats.masteredCount, need: 300 }) },
  ...
  { level: 10, name: "传说", en: "LEGEND", minXp: PEAK_XP[9], challenge: "掌握 1000 个单词",
    progress: (s) => ({ cur: s.stats.masteredCount, need: 1000 }) },
];
